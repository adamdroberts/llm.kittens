...
- run label: `codex_sm120_dry_libtorch_matmul_contract`
- artifact dir: `scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract`
- train output dir: `log124M/5090_S_codex_sm120_dry_libtorch_matmul_contract`
- max steps: `3`
...
Command: `/home/adam/miniconda3/envs/llm-kittens/bin/python dev/write_sm120_round_manifest.py --json-out scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/round-manifest.json --markdown-out scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/round-manifest.md --run-label codex_sm120_dry_libtorch_matmul_contract --artifact-dir scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract --train-out-dir log124M/5090_S_codex_sm120_dry_libtorch_matmul_contract --max-steps 3 --device-arch SM120 --build-jobs 4 --no-multi-gpu 1 --no-use-mpi 1 --run-stack-probe 0 --run-correctness 0 --run-benchmarks 0 --run-python-stack-benchmarks 1 --libtorch-runtime-route cxx-api-raw-pointer --run-libtorch-matmul-benchmarks 1 --libtorch-matmul-shapes fc --run-training 0 --keep-checkpoints 0`
...
```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_matmul.log
```

## Attention Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_attention.log
```

## LayerNorm Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_layernorm.log
```

## Runtime Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_runtime.log
```

## Torch Matmul Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_torch_matmul.log
```

## LibTorch C++ Matmul Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_libtorch_matmul.log
```

## CuTeDSL Matmul Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_cutedsl_matmul.log
```

## Triton Matmul Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_triton_matmul.log
```

## Torch Attention Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_torch_attention.log
```

## cuDNN Attention Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_cudnn_attention.log
```

## Triton Attention Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_triton_attention.log
```

## Torch Classifier Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_torch_classifier.log
```

## Triton Classifier Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_triton_classifier.log
```

## Python Stack LayerNorm Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_layernorm_python_stacks.log
```

## Triton Runtime Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_triton_runtime.log
```

## Torch Runtime Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_torch_runtime.log
```

## LibTorch C++ Runtime Benchmarks

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/bench_sm120_libtorch_runtime.log
```

## Training Steps

```text
missing: scratch/sm120_rounds/codex_sm120_dry_libtorch_matmul_contract/train_gpt2cu.log
```
