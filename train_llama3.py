...
Example launches:
  python train_llama3.py --write_model --model meta-llama/Meta-Llama-3.1-8B
  python train_llama3.py --compile=1 --dtype=bfloat16 --num_iterations=20
"""
...
class MLP(nn.Module):
    ...
    def __init__(self, config):
        super().__init__()
        hidden_dim = llama_hidden_dim(config)
...
def write_model(model, filename, dtype):
    ...
    header[8] = llama_hidden_dim(model.config)
